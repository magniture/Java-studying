package com.zq.spring.annotation.f_typefilter.config;

import com.zq.spring.annotation.f_typefilter.anno.Animal;
import com.zq.spring.annotation.f_typefilter.color.Color;
import com.zq.spring.annotation.f_typefilter.filter.GreenTypeFilter;
