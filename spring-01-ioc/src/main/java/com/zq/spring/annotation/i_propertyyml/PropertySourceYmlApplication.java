package com.zq.spring.annotation.i_propertyyml;

import com.zq.spring.annotation.i_propertyyml.bean.JdbcYmlProperty;
import com.zq.spring.annotation.i_propertyyml.config.JdbcYmlConfiguration;
