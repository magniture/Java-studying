package com.zq.spring.bean.c_instantiate.config;

import com.zq.spring.bean.c_instantiate.bean.BallFactoryBean;
import com.zq.spring.bean.c_instantiate.bean.Car;
import com.zq.spring.bean.c_instantiate.bean.CarInstanceFactory;
import com.zq.spring.bean.c_instantiate.bean.CarStaticFactory;
