package com.zq.spring.aop.c_joinpoint.component;
...
public class Logger {
    ...
    @Before("execution(public * com.zq.spring.aop.c_joinpoint.service.FinanceService.addMoney(..))")
...
//        System.out.println(method.getName());
    ...
    @Pointcut("execution(public * com.zq.spring.aop.c_joinpoint.service.FinanceService.subtractMoney(..))")
