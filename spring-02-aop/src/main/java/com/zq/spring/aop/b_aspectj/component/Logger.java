package com.zq.spring.aop.b_aspectj.component;
...
public class Logger {
    ...
    @Before("execution(public * com.zq.spring.aop.b_aspectj.service.FinanceService.*(..))")
    public void beforePrint() {
        System.out.println("Logger beforePrint run ......");
    }
    
//    @After("execution(* com.linkedbear.spring.aop.b_aspectj.service.*.*(String)))")
    @After("@annotation(com.zq.spring.aop.b_aspectj.component.Log)")
    ...
    @Around("execution(public * com.zq.spring.aop.b_aspectj.service.FinanceService.addMoney(..))")
